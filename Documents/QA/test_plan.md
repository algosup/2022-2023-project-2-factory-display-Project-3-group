...
| Wrong login | Wrong ID and/or wrong password (unknown in the database) entered.| 3 |    1. Enter a wrong login <br /> 2.Enter a wrong password  <br /> 3. Click on login     |    The website displays "Adresse mail ou mot de passe incorrect" and you stay on this page.   |     Working       |     Hard    |          

## Sign up
| Test Name | Description | Number of steps |    Steps list     |    Expected    |       Got       |       Priority       | 
| --------- | ----------------- | -------------------- |    ---------------     |    --------    |       ---       |       ---       | 
| Right sign up | Correct Jacobi email adress, name, family name and password filled | 5 |    1. Enter a name <br> 2. Enter a family name <br> 3. Enter the wanted Jocabi email adress. <br> 4. Enter the new password.  <br /> 5. Click on login     |    A message says "Votre compte a bien été enregistré" is displayed for 5 seconds then you are redirected to the "Accueil" page.    |           |     Medium     | 
| Right sign up | Correct Jacobi email adress, name, family name and password filled | 5 |    1. Enter a name <br> 2. Enter a family name <br> 3. Enter the wanted Jocabi email adress. <br> 4. Enter the new password.  <br /> 5. Click on login     |    A message says "Votre compte a bien été enregistré" is displayed for 5 seconds then you are redirected to the "Accueil" page.    |           |     Medium     | 
| Wrong sign up | Correct Jacobi email adress, name, family name and password filled | 5 |    1. Enter a name <br> 2. Enter a family name <br> 3. Enter the wanted Jocabi email adress. <br> 4. Enter the new password.  <br /> 5. Click on login     |    A message says "Votre compte a bien été enregistré" is displayed for 5 seconds then you are redirected to the "Accueil" page.    |           |     Medium     | 
